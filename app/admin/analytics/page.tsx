        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                <span className={getGrowthColor(analyticsData.overview.customerGrowth)}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{analyticsData.overview.totalReservations}</div>
              <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                <span className={getGrowthColor(analyticsData.overview.reservationGrowth)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Most ordered menu items by revenue</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {analyticsData.topItems.map((item, index) => (
                  <div key={item.name} className="flex items-center justify-between p-3 border rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-emerald-600">${item.revenue.toFixed(2)}</p>
                  ...
                  <div key={school.name} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{school.customers} customers</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold text-blue-600">${school.revenue.toFixed(2)}</p>
                      <p className="text-xs text-gray-500">{school.orders} orders</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              {analyticsData.dailyOrders.map((day) => (
                <div key={day.date} className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-emerald-600">${day.revenue.toFixed(2)}</p>
                    <p className="text-xs text-gray-500">
