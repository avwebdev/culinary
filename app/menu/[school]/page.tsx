...
const allMenuItems = [
  ...
  },
  {
    ...
    available: true,
    schoolId: "foothill",
    nutritionInfo: { calories: 450, protein: 12, carbs: 65, fat: 8 },
  },
  {
    id: "3",
    name: "Beef Burger",
    ...
    available: true,
    schoolId: "amador-valley",
    nutritionInfo: { calories: 680, protein: 35, carbs: 45, fat: 42 },
  },
  {
    id: "4",
  ...
  },
  {
    ...
    available: true,
    schoolId: "foothill",
    nutritionInfo: { calories: 120, protein: 8, carbs: 12, fat: 5 },
  },
  {
    id: "6",
    name: "Avocado Toast",
    description:
      "Toasted sourdough with fresh avocado, chili flakes, and a squeeze of lime.",
    price: 9.5,
    category: "breakfast",
    image:
      "https://images.unsplash.com/photo-1584308666744-8480404b65ae?w=400&h=300&fit=crop",
    popular: true,
    available: true,
    schoolId: "amador-valley",
    nutritionInfo: { calories: 280, protein: 8, carbs: 25, fat: 18 },
  },
  {
    id: "7",
    name: "Club Sandwich",
    description:
      "Classic triple-decker with turkey, bacon, lettuce, and tomato.",
    price: 13.5,
    category: "lunch",
    image:
    ...
    available: true,
    schoolId: "foothill",
    nutritionInfo: { calories: 550, protein: 30, carbs: 40, fat: 30 },
  },
];
...
export default function SchoolMenu() {
  ...
  const [schoolMenuItems, setSchoolMenuItems] = useState(
    allMenuItems.filter((item) => item.schoolId === schoolSlug)
  );
            ...
            <Link href="/cart">
              <Button size="lg" className="relative shadow-md">
                ...
                {cartCount > 0 && (
                  <Badge
                    variant="destructive"
                    className="absolute -top-2 -right-2 h-6 w-6 justify-center rounded-full"
                  >
                    {cartCount}
                  </Badge>
                )}
